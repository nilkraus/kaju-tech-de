document.addEventListener('DOMContentLoaded', function() {
    ...
    if (portuguesLink && inglesLink && alemaoLink && idiomaAtual) {
        ...
        const paginasMapeadas = {
            'uber-uns.html': {pt: 'sobre-nos.html', en: 'about-us.html'},
            'kontakt.html': {pt: 'fale-conosco.html', en: 'contact.html'},
        ...
        alemaoLink.classList.add('idioma-ativo');
        idiomaAtual.textContent = 'DE';
