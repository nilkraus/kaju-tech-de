document.addEventListener('DOMContentLoaded', function() {
    ...
    if (portuguesLink && inglesLink && alemaoLink && idiomaAtual) {
        ...
        const paginasMapeadas = {
            'about-us.html': {de: 'uber-uns.html', pt: 'sobre-nos.html'},
            'contact.html': {de: 'kontakt.html', pt: 'fale-conosco.html'},
            'index.html': {de: 'index.html', pt: 'index.html'}
        };
        ...
        inglesLink.classList.add('idioma-ativo');
        idiomaAtual.textContent = 'EN';
        
        // Configura links para outros idiomas
        if (paginasMapeadas[filename]) {
            alemaoLink.href = '/' + paginasMapeadas[filename].de;
            portuguesLink.href = '/pt/' + paginasMapeadas[filename].pt;
        } else {
            // Fallback para página index
            alemaoLink.href = '/';
            portuguesLink.href = '/pt/';
        }
    }
});